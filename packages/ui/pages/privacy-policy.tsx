  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Describes the Privacy Policy for Pureleap Pty. Ltd."
        />
        ...
        >
          ...
          <div className="max-w-4xl text-gray-800">
            <p className="text-xl mb-8">
              Pureleap Pty. Ltd. is committed to providing quality services to
            ...
            <p className="text-xl mb-8">
              This Personal Information is obtained through correspondence, by
              email, via our website, and from other publicly available sources.
              We don&apos;t guarantee website links or policy of authorised
              third parties.
            </p>
            ...
            <p className="text-xl mb-12">
              ...
              writing. Pureleap Pty. Ltd. will not charge any fee for your
              access request, but may charge an administrative fee for providing
              a copy of your Personal Information. In order to protect your
              Personal Information we may require identification from you before
